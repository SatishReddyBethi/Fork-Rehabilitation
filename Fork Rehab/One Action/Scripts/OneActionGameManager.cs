...
public class OneActionGameManager : MonoBehaviour
{
    ...
    public float MaxKnifePressure = 3.0f;
    public float MaxKnifeGraspPressure = 10.0f;
    public float MaxForkPressure = 10.0f;
    ...
    [HideInInspector]
    public float ScaledForkPressure;
    ...
    public void GameStart()
    {
        ...
        switch (Level)
        {
            case 0:
                ...
                MaxKnifeGraspPressure = Conn.CalKnifeGPressure/2.0f;// Should remove
            ...
            case 1:
                ...
                MaxKnifeGraspPressure = Conn.CalKnifeGPressure * (2.0f / 3.0f);// Should remove
                Elevator.SetActive(false);
                AngleScale = 150.0f;
                break;
            ...
            case 2:
                ...
                MaxKnifeGraspPressure = Conn.CalKnifeGPressure;// Should remove
        ...
        if(Level == 3)
        {
            LvlObjects[1].SetActive(true);
            LvlObjects[0].SetActive(false);
            Hand.SetActive(true);
        }
        else
        {
            LvlObjects[0].SetActive(true);
            LvlObjects[1].SetActive(false);
