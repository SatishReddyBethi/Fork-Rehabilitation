...
public class USART : MonoBehaviour
{
   ...
   /* void Invokeup_date()
    ...
    public void Save_Statics()
    {
        ...
        // Debug.Log("/Level_" + (lvl.value + 1).ToString() + "_Data");
        SaveData(Name.text + "," + Gender.options[Gender.value].text + "," + Age.options[Age.value].text + "\n", false, savedDataPath + "/Level_" + (lvl.value+1).ToString() + "_Data"); //+ "," + Dexterity.options[Dexterity.value].text 
    }
