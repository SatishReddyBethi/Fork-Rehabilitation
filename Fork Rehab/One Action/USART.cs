...
public class USART : MonoBehaviour
{
   ...
   /* void Invokeup_date()
            ...
            case 1:
                ...
                if (forces.Length == 3)
                {
                    ...
                    if (ReadStatus)
                    {
                        ...
                        {
                            // Assign each variable in the string
                            KnifePressure = float.Parse(forces[2]);
                            if (KnifePressure > 20)
                            {
                                KnifePressure = 20.0f;
                            }
                            PressurePadValue = float.Parse(forces[0]);
                            KnifeGPressure = float.Parse(forces[1]);
                            if (KnifeGPressure > 20)
                            {
                                KnifeGPressure = 20.0f;
                            }
    ...
    public void Save_Statics()
    {
        ...
        SaveData(Name.text + "," + Gender.options[Gender.value].text + "," + Age.options[Age.value].text + "," + Dexterity.options[Dexterity.value].text + "\n", false);
    }
    ...
    public void SaveData(string Data, bool Replace)
    {
        ...
        string FileName = savedDataPath + "/" + "RF_" + Time_ + ".txt";
